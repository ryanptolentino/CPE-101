...
class TestData(unittest.TestCase):
    ...
    def test_sphere_equals(self):
        ...
        pt3 = data.Point(4, 5, 6)
        sphere1 = data.Sphere(pt1, 3.5, data.Color(255, 255, 255), 1)
        sphere2 = data.Sphere(pt2, 3.5, data.Color(255, 255, 255), 1)
        sphere3 = data.Sphere(pt3, 3.5, data.Color(255, 255, 255), 1)
        sphere4 = data.Sphere(pt1, 6.5, data.Color(255, 255, 255), 1)
    ...
    def test_cast_ray(self):
        ...
        sphere_list = [sphere1, sphere2, sphere3]
        self.assertEqual(cast.cast_ray(r1, sphere_list, data.Color(255, 255, 255)), '255 255 255')
